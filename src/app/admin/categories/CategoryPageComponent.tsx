...
const CategoriesPageComponent: FC<Props> = ({ categories }) => {
    ...
    const [currentCategory,setCurrentCategory] = useState<CreateCategorySchema| null>()
    ...
    const SubmitCategoryHandler: SubmitHandler<CreateCategorySchema> = async (data) => {
        ...
        switch(intent){
            case 'create': {
                ...
                if(imageUrl){
                    await createCategory({imageUrl,name:name})
                    form.reset();
                    router.refresh();
            ...
            case 'update': {
                ...
                console.log("fuck you 2");
                        ...
                        const lund =  await updateCategory({imageUrl,name: data.name,slug: currentCategory.slug,intent:'update'})
                        console.log(lund,"lin");
            ...
            <Card className='overflow-x-auto'>
                ...
                <CardContent>
                    <Table className='min-w-[600px]'>
                        ...
                        <TableBody>
                            {
                                categories.map(category=><CategoryTableRow key={category.id} category={category} setCurrentCategory={setCurrentCategory}
